 ...
 * @ingroup Skins
 */
$wgValidSkinNames['lesswrong'] = 'LessWrong';
 ...
 * @ingroup Skins
 */
class SkinLessWrong extends SkinTemplate {
	/** Using lesswrong. */
	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'LessWrong';
		$this->stylename = 'LessWrong';
		$this->template  = 'LessWrongTemplate';
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( "./LessWrong/main.css", 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( "$wgHandheldStyle", "./LessWrong/handheld" );
		}

		$out->addStyle( "./LessWrong/IE60Fixes.css", 'screen', 'IE 6' );
		$out->addStyle( "./LessWrong/IE70Fixes.css", 'screen', 'IE 7' );

		$out->addStyle( "./LessWrong/print.css", 'print' );
 ...
 * @ingroup Skins
 */
class LessWrongTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for LessWrong skin.
...
<div id="globalWrapper">
	...
	<div id="header">
			...
			<a id="cfar" href="http://appliedrationality.org/" target="_blank">Center for Applied Rationality</a>
	</div><!-- #header -->

	<div id="p-personal" class="clear">
		<a class="back" href="http://lesswrong.com/">Back to LessWrong</a>
		<ul>
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-5818093-4");
...
<?php		}
		...
		wfRunHooks( 'LessWrongTemplateToolboxEnd', array( &$this ) );
